...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid fixed-top px-0">
            ...
            <nav class="navbar mx-3 navbar-light bg-white navbar-expand-xl">
                <a href="index.php" class="navbar-brand">
                    <h2 class="text-primary display-6">Buscador de Vinos</h2>
                </a>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">"<?=$busqueda?>"</h1>
                        ...
                        <div class="row g-4">
                            ...
                            <form action="shop.php" method="post">
                                <div class="input-group w-100 mx-auto d-flex">
                                    <input type="search" class="form-control p-3" name="busqueda" placeholder="Buscar" aria-describedby="search-icon-1">
                                        ...
                                        if (isset($data['results']) && is_array($data['results'])) {
                                            if (!empty($data['results'])) {
                                                foreach ($data['results'] as $product) {
                                                    ...
                                                    $image_url = "https://http2.mlstatic.com/D_NQ_NP_$thumbnail_id-W.webp";
                                                    $max_length = 50;
                                                    if (strlen($title) > $max_length) {
                                                        $title = substr($title, 0, $max_length) . '...';
                                                    }
                                        ?>      
                                            <div class="col-md-6 col-lg-6 col-xl-4" title="<?=$titleOriginal?>">
                                                <div class="rounded position-relative fruite-item">
                                                    <div class="fruite-img">
                                                        <img src="<?= $image_url ?>" class="img-fluid w-100 rounded-top" alt="<?=$titleOriginal?>" style="min-height: 200px; height: 300px; object-fit: contain;">
                                                    </div>
